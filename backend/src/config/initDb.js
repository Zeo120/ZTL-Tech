...
const tables = [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'previous_hash', sql: 'NVARCHAR(64) NULL' },
      { name: 'current_hash', sql: 'NVARCHAR(64) NULL' },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'pan', sql: 'NVARCHAR(255) NOT NULL CONSTRAINT DF_Employees_pan DEFAULT N\'\'' },
      ...
      { name: 'aadhar', sql: 'NVARCHAR(255) NOT NULL CONSTRAINT DF_Employees_aadhar DEFAULT N\'\'' },
