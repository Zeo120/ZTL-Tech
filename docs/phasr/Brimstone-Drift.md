...
- **Windows x86-64:** C Wrapper & Fallback Engine ([telemetry_collector.c](file:///d:/Project%20XT/phasr/Brimstone-Drift/telemetry_collector.c)) compiled with MSVC `cl.exe`.
- **Linux x86-64:** GNU Assembler Intel-syntax Assembly ([telemetry_linux_x64.s](file:///d:/Project%20XT/phasr/Brimstone-Drift/telemetry_linux_x64.s)) using System V AMD64 ABI.
- **Linux ARM64:** GNU Assembler AArch64 Assembly ([telemetry_arm64.s](file:///d:/Project%20XT/phasr/Brimstone-Drift/telemetry_arm64.s)) using AAPCS64 ABI.
- **Build System:** Cross-platform [Makefile](file:///d:/Project%20XT/phasr/Brimstone-Drift/Makefile) and Windows [build.bat](file:///d:/Project%20XT/phasr/Brimstone-Drift/build.bat) script.
