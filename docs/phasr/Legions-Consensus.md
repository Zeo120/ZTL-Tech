...
- **Windows x86-64:** C Fallback Engine ([consensus_auditor.c](file:///d:/Project%20XT/phasr/Legions-Consensus/consensus_auditor.c)) compiled with MSVC `cl.exe`.
- **Linux x86-64:** GNU Assembler Intel-syntax Assembly ([consensus_linux_x64.s](file:///d:/Project%20XT/phasr/Legions-Consensus/consensus_linux_x64.s)) using System V AMD64 ABI.
- **Linux ARM64:** GNU Assembler AArch64 Assembly ([consensus_arm64.s](file:///d:/Project%20XT/phasr/Legions-Consensus/consensus_arm64.s)) using AAPCS64 ABI.
- **Build System:** Cross-platform [Makefile](file:///d:/Project%20XT/phasr/Legions-Consensus/Makefile) and Windows [build.bat](file:///d:/Project%20XT/phasr/Legions-Consensus/build.bat) script.
