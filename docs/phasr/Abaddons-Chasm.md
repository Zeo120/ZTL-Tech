...
- **Windows x86-64:** Modern C++ Fallback Engine ([chaos_verifier.cpp](file:///d:/Project%20XT/phasr/Abaddons-Chasm/chaos_verifier.cpp)) compiled with MSVC `cl.exe`.
- **Linux x86-64:** GNU Assembler Intel-syntax Assembly ([control_linux_x64.s](file:///d:/Project%20XT/phasr/Abaddons-Chasm/control_linux_x64.s)) using System V AMD64 ABI.
- **Linux ARM64:** GNU Assembler AArch64 Assembly ([control_arm64.s](file:///d:/Project%20XT/phasr/Abaddons-Chasm/control_arm64.s)) using AAPCS64 ABI.
- **Build System:** Cross-platform [Makefile](file:///d:/Project%20XT/phasr/Abaddons-Chasm/Makefile) and Windows [build.bat](file:///d:/Project%20XT/phasr/Abaddons-Chasm/build.bat) script.
